...
def main():
    ...
    scheduler.register_agent("AFImportanceDiffusionAgent", 
        lambda: AgentObject(metta=metta, path="./agents/mettaAgents/AFImportanceDiffusionAgent.metta"))
    scheduler.register_agent("AFRentCollectionAgent", 
        lambda: AgentObject(metta=metta, path="./agents/mettaAgents/AFRentCollectionAgent.metta"))
